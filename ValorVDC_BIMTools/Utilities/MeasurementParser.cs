...
public class MeasurementParser
{
    ...
    public static double ParseFractionalInches(string input)
    {
        ...
        try
        {
            ...
            if (match.Success)
            {
                ...
                {
                    wholeNumber = double.Parse(match.Groups[1].Value);
                }
            ...
            throw new ArgumentException($"Invalid format: '{originalInput}'. Expected: whole numbers (3), decimals (3.5), fractions (1/2), mixed fractions (3 1/2), or any of these with inch symbol (3\", 1/2\")");
        }
    ...
    public static (double feet, double ninches) ParseArchitecturalLength(string input)
    {
        ...
        if(double.TryParse(input, out double decimalFeet))
        ...
        if (input.Contains("'"))
        {
            ...
            {
                double feet = double.Parse(traditionalMatch.Groups[1].Value);
                double inches = 0;
            ...
            {
                double feet = double.Parse(compactMatch.Groups[1].Value);
                double inches = 0;
            ...
            {
                double feet = double.Parse(feetOnlyMatch.Groups[1].Value);
                return (feet, 0);
            }
